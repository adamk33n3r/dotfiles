...
function init()
{
	...
	changeAccessButtonStatus(background_page.oauth.hasToken());
}
...
{
	background_page.OnAuthorizeCallBack = OnAuthorize;
...
function OnAuthorize()
{
	...
	background_page.OnAuthorizeCallBack = undefined;
}

function revokeAccess()
{
	background_page.oauth.clearTokens();
