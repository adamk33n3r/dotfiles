...
(function() {
  ...
  DomUtils = {
    ...
    makeXPath: function(elementArray) {
      var element, xpath, _i, _len;
      xpath = [];
      for (_i = 0, _len = elementArray.length; _i < _len; _i++) {
        element = elementArray[_i];
    ...
    isSelectable: function(element) {
      ...
      return (element.nodeName.toLowerCase() === "input" && unselectableTypes.indexOf(element.type) === -1) || element.nodeName.toLowerCase() === "textarea";
    },
