...
(function() {
  ...
  settings = {
    ...
    values: {},
    loadedValues: 0,
    valuesToLoad: ["scrollStepSize", "linkHintCharacters", "linkHintNumbers", "filterLinkHints", "hideHud", "previousPatterns", "nextPatterns", "findModeRawQuery", "regexFindMode", "userDefinedLinkHintCss", "helpDialog_showAdvancedCommands", "smoothScroll"],
    isLoaded: false,
    eventListeners: {},
    init: function() {
  ...
  initializeWhenEnabled = function(newPassKeys) {
    ...
    if (!installedListeners) {
      ...
      return installedListeners = true;
    }
  };
  ...
  onKeyup = function(event) {
    ...
    if (handledKeydown) {
      return DomUtils.suppressPropagation(event);
    }
  };
  ...
  updateFindModeQuery = function() {
    var error, escapeRegExp, hasNoIgnoreCaseFlag, parsedNonRegexQuery, pattern, text, _ref, _ref1;
    ...
    if (findModeQuery.isRegex) {
      ...
      return findModeQuery.matchCount = (_ref = findModeQuery.regexMatches) != null ? _ref.length : void 0;
    } else {
      escapeRegExp = /[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g;
      ...
      text = document.body.innerText;
      return findModeQuery.matchCount = (_ref1 = text.match(pattern)) != null ? _ref1.length : void 0;
    }
  };
  ...
  HUD = {
    ...
    showUpgradeNotification: function(version) {
      var links;
      HUD.upgradeNotificationElement().innerHTML = "Vimium has been updated to <a class='vimiumReset' href='https://chrome.google.com/extensions/detail/dbepggeogbaibhgnhhndojpepiihcmeb'> " + version + "</a>.<a class='vimiumReset close-button' href='#'>&times;</a>";
