...
$(function() {
    ...
    var buttons = document.querySelectorAll('#page-menu a, #page-menu span');
    for (var i = 0; i < buttons.length; i++)
    {
        buttons[i].addEventListener('click', function(e){
            trackButton('Popup','Menu',e.target.getAttribute('data-analytics-id'));
        });
    }
    ...
    $('#social_show').click(function(){
        ...
        $('#social ul').show();
        $('#social').slideDown(400, function() { $('#social_hide').css('display','block'); });
    });
    $('#social_hide').click(function(){
        $(this).css('display','none');
        $('#social').slideUp(400, function() { $('#social_show').css('display','block'); });
    });

    $("h1").click(function() {
        openTabOnce(webstoreUrl);
    });
    ...
    $('#page-menu a[href="#"]').click(function(e){
        ...
        setTimeout(function(){
            if(pageName == 'today'){
                ...
                $('#backup_your_data').css('display','block');
                ...
                $('#backup_your_data').css('display','none');
            }
        },500);
    ...
    $('#backup_your_data').click(function(){
        trackButton('Popup','Premium','Small button');
    });
    ...
    if(!bgPage.control.isPremium){
        $('.open_options_page_premium').css('display','block');
    }else{
        $('#backup_your_data').attr('style','display:none !important;');
    }
    $('.open_options_page_premium').click(function(){
