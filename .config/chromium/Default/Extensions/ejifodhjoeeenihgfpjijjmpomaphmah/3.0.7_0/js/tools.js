...
function getDefaultOptions()
{
    var options = {
        ...
        dashboard_items: [false,true,true,true,true,true,true,true,true,true],
...
function getOptions()
{
    var options = storage_get('options');
    options.dashboard_items[0] = false;
    return options;
}
...
{   
    ...
    //PREMIUM: kdyz neni specialProfileVisits tak vzdy jde o pref visits !!!!!
    if(specialProfileVisits){
        
        visits = storage_get(specialProfileVisits);
